...
const TARGET_DIR = (fs.existsSync(BUILD_DIR)) ? BUILD_DIR : DIST_DIR;
...
const ASSET_MANIFEST_PATH = path.join(TARGET_DIR, 'asset-manifest.json');
...
module.exports = {
  ...
  libs: {
    name: 'react-spacomponents',
    allowProxy: true,
    categories: ['core.wcm.react.spacomponents'],
    dependencies: ['cmp-react-examples.base'],
